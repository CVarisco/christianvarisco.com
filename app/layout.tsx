...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <html lang="en">
      <body
        className={`antialiased bg-zinc-900 text-zinc-50 ${helvetica.variable} font-sans`}
      >
          ...
          <header className="px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="ml-auto text-sm font-medium space-x-6">
                ...
                <a className="bg-lime text-black font-bold py-2 px-4 rounded-full cursor-pointer">
                  Book a call
                </a>
              </nav>
            </div>
          </header>
          <main className="container mx-auto grow px-6 md:px-0">
            {children}
          </main>
