...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <html lang="en">
      <body
        className={`antialiased bg-black text-zinc-50 ${helvetica.variable} font-sans`}
      >
        <div className="flex flex-col h-screen">
          <header className="px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="flex items-center text-sm font-medium space-x-4 md:space-x-6">
                ...
                <a
                  className="group -m-1 p-1 hidden md:block"
                ...
                <a className="bg-lime text-black font-bold py-1 px-2 md:py-2 md:px-4 rounded-full cursor-pointer min-w-[100px] text-center">
                  Book a call
                </a>
              </nav>
            </div>
          ...
          <footer className="w-full flex gap-6 justify-center py-4 mt-10">
            ...
            <a
              className="group -m-1 p-1 md:hidden block"
              aria-label="Follow on GitHub"
              href="https://github.com/CVarisco"
            >
              <svg
