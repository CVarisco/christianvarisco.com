    ...
    <html lang="en">
      ...
      >
        <div className="flex flex-col h-screen">
          ...
          <footer className="flex flex-col items-center  bg-lime text-center text-surface text-black">
            <div className="container pt-4">
              <div className=" flex justify-center space-x-2">
                <a
                  href="https://twitter.com/ChriVarisco"
                  type="button"
                ...
                <a
                  href="https://www.youtube.com/@christianvarisco"
                  type="button"
                  className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                  data-twe-ripple-init
                  target="_blank"
                ...
                <a
                  href="https://www.twitch.tv/christian_varisco"
                  type="button"
                  className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                  data-twe-ripple-init
                  target="_blank"
            ...
            <div className="w-full py-4 text-center font-serif font-semibold">
              <a href="mailto:info@christianvarisco.com" className="">
                © 2024 Christian Varisco All right reserved.
              </a>
            </div>
          </footer>
        </div>
